...
const HERO_IMG = 'https://res.cloudinary.com/dhshucomg/image/upload/v1779519628/z7856807100962_3bcd34d39f175efe58f006b7b4658229_s2897y.jpg';
    ...
    <section id="hero" className="relative min-h-screen flex items-center overflow-hidden grain-overlay">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 md:px-10 lg:px-16 py-32 w-full">
        <div className="max-w-2xl">
          ...
          >
            Chuyên Thu Mua{' '}
            <span className="text-gradient italic">Cửa Cuốn, Cửa Nhôm Kính Cũ</span><br />
            & Đồ Gỗ{' '}
          ...
          <motion.p {...fadeUp(0.36)} className="font-body text-cream/75 text-base md:text-lg leading-relaxed mb-8 max-w-lg">
            Chuyên thu mua cửa nhôm kính cũ, đồ gỗ cũ, cửa nhôm Xingfa, cửa cuốn, nội thất đã qua sử dụng tại TP.HCM —
