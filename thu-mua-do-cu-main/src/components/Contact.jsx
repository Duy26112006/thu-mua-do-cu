  ...
  return (
    <section id="contact" className="py-24 md:py-32" style={{ background: "var(--cream)" }}>
     ...
     <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }} className="flex flex-col sm:flex-row gap-5 justify-center mb-16">
          <a href="tel:0938228764" onClick={() => handleConversion("tel:0938228764")} className="flex items-center justify-center gap-4 px-10 py-6 rounded-2xl text-white font-body font-semibold transition-all duration-300 hover:-translate-y-1" style={{ background: "linear-gradient(135deg, var(--amber), var(--gold))", boxShadow: "0 8px 30px rgba(196,30,58,0.4)" }}>
          ...
          <a href="https://zalo.me/0938228764" target="_blank" rel="noopener noreferrer" onClick={() => handleConversion("https://zalo.me/0938228764")} className="flex items-center justify-center gap-4 px-10 py-6 rounded-2xl text-white font-body font-semibold transition-all duration-300 hover:-translate-y-1" style={{ background: "linear-gradient(135deg, #0068FF, #0099FF)", boxShadow: "0 8px 30px rgba(0,104,255,0.4)" }}>
